 ...
 * class EfficientMarkovWord implements IMarkovModel and that 
 * builds a HashMap to calculate the follows ArrayList for each 
 * possible WordGram only once, and then uses the HashMap 
