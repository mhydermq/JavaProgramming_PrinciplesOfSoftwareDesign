...
public class MarkovWordOne implements IMarkovModel {
	...
	//the method returns an ArrayList of all the single words that
	//immediately follow the key in the training text
    ...
    //looks at the start position and returns the first index location in 
    //words that matches target. If no word is found, then returns -1.
