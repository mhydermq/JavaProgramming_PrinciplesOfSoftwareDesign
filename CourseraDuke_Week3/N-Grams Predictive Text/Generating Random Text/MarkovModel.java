...
public class MarkovModel {
    ...
    /**
     * Predicts the next character by finding all the 
     * characters that follow a substring of keyLength
     * characters in the training text, and then randomly 
    ...
    public String getRandomText(int numChars){
        ...
        // Generate a random index from valid indexes 
        //(those that have following characters)
        int index = myRandom.nextInt(myText.length() - keyLength);
        // Assign to key the character string at the random index 
        //that is keyLength long
        ...
        for(int k=0; k < numChars - keyLength; k++){
            ...
            sb.append(successor);
            // Combine old key (except first character) with 
            //successor to make next key
