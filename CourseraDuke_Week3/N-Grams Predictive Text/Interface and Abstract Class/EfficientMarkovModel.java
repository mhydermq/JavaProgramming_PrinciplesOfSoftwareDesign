...
public class EfficientMarkovModel extends AbstractMarkovModel{
    ...
    public String getRandomText(int numChars){
        ...
        sb.append(key);
        //generate numChars minus four because they are set before the loop
    ...
    private void buildMap() {
        ...
        for (int pos = 0; pos <= myText.length() - order; pos++) {
            ...
            // Add to HashMap the character that follows 
            //current substring, if there is one
    ...
    public void printHashMapInfo() {        
        ...
        //the size of the largest largest ArrayList of characters in the HashMap
        int largestSize = 0; 
        ...
        System.out.println("The size of the largest ArrayList of characters: " 
                             + largestSize);
        
        //the keys that have the maximum size value
